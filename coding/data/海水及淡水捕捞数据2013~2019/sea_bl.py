...
def saveData(city, year, kind, num):
    ...
    sql = "insert into sea_bl( city, year, kind, num) values ('%s',%d,'%s',%d)" % (
        city, (year), kind, (num))
    # 执行sql
    print(sql)
    cur.execute(sql)
...
time.sleep(1)
p_input2 = driver.find_element(By.XPATH, '//*[@id="365"]').click()
time.sleep(1)
...
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[39]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[40]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[41]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[45]/input').click()
...
listData = []
i = 0
for j in tr[0:224]:  # tr2[1:]遍历第1列到最后一列，表头为第0列
    # city='全国'
    td = j.xpath('td')
    if i % 7 == 0:
