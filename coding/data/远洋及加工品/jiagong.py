...
def saveData(city, year, kind, num):
    ...
    sql = "insert into jiagong( city, year, kind, num) values ('%s',%d,'%s',%d)" % (
        city, (year), kind, (num))
    # 执行sql
    print(sql)
    cur.execute(sql)
...
time.sleep(1)
p_input2 = driver.find_element(By.XPATH, '//*[@id="374"]').click()
time.sleep(1)
...
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[14]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[17]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[18]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[19]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[20]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[21]/input').click()
time.sleep(1)
...
listData = []
i = 0
for j in tr[0:256]:  # tr2[1:]遍历第1列到最后一列，表头为第0列
    # city='全国'
    td = j.xpath('td')
    if i % 8 == 0:
