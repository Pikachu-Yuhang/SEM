...
def saveData(city, year, kind, num):
    ...
    sql = "insert into jjzzz_nj( city, year, kind, num) values ('%s',%d,'%s',%d)" % (
        city, (year), kind, (num))
    # 执行sql
    print(sql)
    cur.execute(sql)
...
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[22]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[23]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[29]/input').click()
p_input2 = driver.find_element(
    By.XPATH, '//*[@id="ItemsList"]/dd[38]/input').click()
...
# print(listData)
city = '全国总计'
saveData(city, 2013, '渔业经济增加值（万元）',  cn1_2013)
saveData(city, 2014, '渔业经济增加值（万元）',  cn1_2014)
saveData(city, 2015, '渔业经济增加值（万元）',  cn1_2015)
saveData(city, 2016, '渔业经济增加值（万元）',  cn1_2016)
saveData(city, 2017, '渔业经济增加值（万元）',  cn1_2017)
saveData(city, 2018, '渔业经济增加值（万元）',  cn1_2018)
saveData(city, 2019, '渔业经济增加值（万元）',  cn1_2019)
